...
<head>
    ...
    <title>Grazie! | liveXperience</title>
    <!-- ============= RESET STYLE ============= -->
...
<body onload="onLoad(<?php echo $session ?>, <?php echo $valAdmin ?>)">
    ...
    <!-- ============= GRAZIE ============= -->
        <div class="center">
            <h1>L'acquisto è andato a buon fine.</h1>
        </div>
        
        <div class="body-grazie">
        
        <div class="gr-image">
            <img class="grazieImg" src="images/grazie.svg">
        </div>
        <div class="gr-btn">
            <a href="index.php"><button><i class="fas fa-home"></i>&nbsp; Torna alla Homepage</button></a>
            <a href="profile.php"><button><i class="fas fa-user"></i>&nbsp; Visualizza gli acquisti nel profilo</button></a>
        </div>
    </div>
