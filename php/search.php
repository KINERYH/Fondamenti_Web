...
<body onload="onLoad(<?php echo $session ?>, <?php echo $valAdmin ?>)">
    ...
    // vero o falso a seconda che l'utente sia arrivato sulla pagina cliccando il menu a tendina o cercando nella barra di ricerca
    $isCategoria;
    ...
    // creo una variabile vuota eventi
    $eventi = "";
